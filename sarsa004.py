...
class NaiveAgent():
    ...
    def __createStateDict(self):
        ...
        state = {}
        state_key = 0
        # for verticle_distance in range(-310,420): # bucketed by 10
        # for verticle_distance in range(-39,53):   # bucketed by 8
        # for verticle_distance in range(-62,84):   # bucketed by 5
        # for verticle_distance in range(-155, 210):  # bucketed by 2
        for verticle_distance in range(-104, 140):  # bucketed by 3
            ...
            # for next_pipe_dist_to_player in range(32):
                ...
                # for verticle_distance_upper_pipe in range(-11,8): # bucketed by 40
                for verticle_distance_upper_pipe in range(-17,13): # bucketed by 25
                ...
                # for player_vel in range(-10,10):
                    ...
                    # state[state_key] = {'verticle_distance_upper_pipe' : verticle_distance_upper_pipe }
                    state[state_key] = { 'verticle_distance' : verticle_distance, 'verticle_distance_upper_pipe' : verticle_distance_upper_pipe }
                    # state[state_key] = { 'verticle_distance' : verticle_distance}
...
def sarsa():
    ...
    for episode in range(1):
        ...
        print('Episode = ' + str(episode) + ', Reward = ' + str(cumulative_reward))
        # print(gp)
        # print(Q)
